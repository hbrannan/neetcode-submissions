class Solution:
    def characterReplacement(self, s: str, k: int) -> int:
        ...
        # I never got this to fully work; I understand its less efficient than max count; don't understand why non-working.
        # if len(s) <= k:
        #     return len(s)
        ...
        # This is the solve for the site. I don't really understand why it is ok to change window but never decrement max_f 
        # l = 0
        # count = {}
        # max_freq = 0
        # longest_len = 0
